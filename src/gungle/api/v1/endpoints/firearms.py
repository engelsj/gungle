...
@router.get("/", response_model=List[Firearm])  # type: ignore[misc]
async def get_all_firearms() -> List[Firearm]:
    return firearm_service.get_all_firearms()


@router.get("/{firearm_id}", response_model=Firearm)  # type: ignore[misc]
...
@router.post("/", response_model=Firearm)  # type: ignore[misc]
...
@router.put("/{firearm_id}", response_model=Firearm)  # type: ignore[misc]
...
@router.delete("/{firearm_id}")  # type: ignore[misc]
